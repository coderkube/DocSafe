...
import 'package:docsafe/awsome_card/extra/card_type.dart';
import 'package:docsafe/awsome_card/extra/helper.dart';
import 'package:docsafe/awsome_card/style/card_back_layout.dart';
import 'package:docsafe/awsome_card/style/card_front_layout.dart';
...
class AwesomeCard extends StatelessWidget {
  ...
  const AwesomeCard({super.key, required this.animation, required this.child});
